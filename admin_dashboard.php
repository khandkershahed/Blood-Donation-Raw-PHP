...
try {
    ...
    $query2 = "SELECT * FROM users WHERE registration_type IN ('donor', 'both')";
    $query3 = "SELECT * FROM users WHERE registration_type IN ('receiver', 'both')";
    ...
    // $stmt4->bindParam(':admin_id', $admin_id, PDO::PARAM_INT);
    ...
    $requests3 = $stmt3->fetchAll(PDO::FETCH_ASSOC);
    $count = count($requests);
    $count2 = count($requests2);
    $count3 = count($requests3);
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 col-xl-4">
                    <a href="<?= ROOT_URL ?>user/allRequest_admin.php">
                        <div class="card">
                            <div class="card-body">
                                <div class="widget-first">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <p class="mb-0 text-dark fs-15">Total Requests</p>
                                    </div>
                ...
                <!-- Total Donor Widget -->
                <div class="col-md-6 col-lg-4 col-xl-4">
                    <a href="<?= ROOT_URL ?>user/allDonor_admin.php">
                        <div class="card">
                            <div class="card-body">
                                <div class="widget-first">
                                    <div class="d-flex align-items-center mb-2">
                ...
                <div class="col-md-6 col-lg-4 col-xl-4">
                    <a href="<?= ROOT_URL ?>user/allReceiver_admin.php">
                        <div class="card">
                            <div class="card-body">
                                <div class="widget-first">
                                    <div class="d-flex align-items-center mb-2">
                                        <div class="p-2 border border-secondary border-opacity-10 bg-secondary-subtle rounded-2 me-2">
                                            <div class="widget-size text-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="30" x="0" y="0" viewBox="0 0 419.005 419.005" style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                                                    <g>
                                                        <linearGradient id="a" x1="71.1" x2="67.962" y1="329.164" y2="95.368" gradientUnits="userSpaceOnUse">
                                                        ...
                                                        <path fill="#d64c52" d="M121.799 333.598H90.84c-13.063 0-23.691-10.628-23.691-23.691V188.46h4.479v121.446c0 10.593 8.619 19.211 19.212 19.211h30.959z" opacity="1" data-original="#d64c52"></path>
                                                        <path fill="#b8b1bb" d="M50.042 185.222h10.723v15.133H50.042zM77.664 185.222h10.723v15.133H77.664z" opacity="1" data-original="#b8b1bb"></path>
                                                        <path fill="#e5dcdf" d="m113.798 49.865-12.917-8.827a56.317 56.317 0 0 0-63.408 0l-13.094 8.827c-4.552 3.099-7.404 8.25-7.404 13.757v77.305c0 9.232 2.932 18.638 8.149 26.254L37.89 186h62.649l12.526-18.819c5.218-7.617 7.911-17.022 7.911-26.254V63.622c-.001-5.507-2.626-10.658-7.178-13.757zM87.014 52h-35.61c-2.789 0-3.903-3.775-1.599-5.348l.272-.271c5.665-3.857 12.282-5.947 19.136-5.947a33.86 33.86 0 0 1 19.135 5.887l.265.341C90.917 48.234 89.804 52 87.014 52z" opacity="1" data-original="#e5dcdf"></path>
                                                        <path fill="#f4d7c3" d="M314.004 319.159h46.021v56.965h-46.021zM90.901 319.159h46.021v56.965H90.901z" opacity="1" data-original="#f4d7c3" class=""></path>
                                                        <path fill="#b8b1bb" d="M136.475 206c-26 3-46.5 24.753-46.5 51.612V322h46v55h178v-55h46v-64.388c0-26.859-20.5-48.612-45.5-51.612z" opacity="1" data-original="#b8b1bb"></path>
                                                        <path fill="#fcf5f0" d="M313.738 339.531h33.157v17.023h-33.157z" opacity="1" data-original="#fcf5f0"></path>
                                                        <path fill="#d64c52" d="m195.532 311.36 30.755-58.501 30.755 58.501c12.163 23.137-4.616 50.913-30.754 50.913-26.14 0-42.919-27.777-30.756-50.913z" opacity="1" data-original="#d64c52"></path>
                                                        <path fill="#fcf5f0" d="M244.975 317h-12v-12h-15v12h-11v15h11v11h15v-11h12z" opacity="1" data-original="#fcf5f0"></path>
                                                        <path fill="#f4bba2" d="M163.05 118.559c8.337 0 15.158-6.821 15.158-15.158V88.784c0-8.337-6.821-15.158-15.158-15.158s-15.158 6.821-15.158 15.158V103.4c0 8.338 6.821 15.159 15.158 15.159zM288.699 118.559c-8.337 0-15.158-6.821-15.158-15.158V88.784c0-8.337 6.821-15.158 15.158-15.158s15.158 6.821 15.158 15.158V103.4c.001 8.338-6.82 15.159-15.158 15.159z" opacity="1" data-original="#f4bba2" class=""></path>
                                                        <path fill="#f4d7c3" d="M236.454 235.905H216.12c-11.703 0-21.19-9.487-21.19-21.19V109.516h62.715v105.198c-.001 11.704-9.488 21.191-21.191 21.191z" opacity="1" data-original="#f4d7c3" class=""></path>
                                                        <path fill="#f4bba2" d="M256.975 214.198V119h-63v63.834z" opacity="1" data-original="#f4bba2" class=""></path>
                                                        <path fill="#f4d7c3" d="M226.287 180.804c-35.233 0-64.06-28.827-64.06-64.06V56.865c0-31.212 25.537-56.749 56.749-56.749h14.622c31.212 0 56.749 25.537 56.749 56.749v59.879c0 35.233-28.827 64.06-64.06 64.06z" opacity="1" data-original="#f4d7c3" class=""></path>
                                                        <path fill="#f4bba2" d="M226.287 131.336c-4.79 0-8.709-3.919-8.709-8.709v-13.043c0-4.79 3.919-8.709 8.709-8.709 4.79 0 8.709 3.919 8.709 8.709v13.043c-.001 4.79-3.919 8.709-8.709 8.709z" opacity="1" data-original="#f4bba2" class=""></path>
                                                        <g fill="#3a2f32">
                                                            <path d="M226.287 153.477c-6.294 0-12.193-2.435-16.613-6.854l1.414-1.414c4.042 4.043 9.44 6.269 15.199 6.269s11.157-2.226 15.199-6.269l1.414 1.414c-4.42 4.419-10.319 6.854-16.613 6.854zM197.113 96.092a4.524 4.524 0 0 1-4.511-4.511v-4.38a4.524 4.524 0 0 1 4.511-4.511 4.524 4.524 0 0 1 4.511 4.511v4.38a4.524 4.524 0 0 1-4.511 4.511zM255.461 96.092a4.524 4.524 0 0 0 4.511-4.511v-4.38a4.524 4.524 0 0 0-4.511-4.511 4.524 4.524 0 0 0-4.511 4.511v4.38a4.524 4.524 0 0 0 4.511 4.511z" fill="#3a2f32" opacity="1" data-original="#3a2f32"></path>
                                                        </g>
                                                        <path fill="#7c5952" d="M233.598 0h-14.622c-31.212 0-57.001 24.653-57.001 55.865v16.726c88-1.533 88.755-42.753 88.755-42.753s1.245 36.041 39.245 42.75V55.865C289.975 24.653 264.81 0 233.598 0z" opacity="1" data-original="#7c5952" class=""></path>
                                                        <path fill="#d64c52" d="M112.252 67.605v68.491a52.637 52.637 0 0 1-9.177 29.695l-7.198 10.534H42.551l-7.198-10.534a52.63 52.63 0 0 1-9.177-29.695V67.605c0-.875.585-1.642 1.429-1.873l15.579-4.269a98.498 98.498 0 0 1 52.052-.002l15.588 4.27a1.944 1.944 0 0 1 1.428 1.874z" opacity="1" data-original="#d64c52"></path>
                                                        <path fill="#ffffff" d="M38.389 83.548h61.651v59.185H38.389z" opacity="1" data-original="#ffffff" class=""></path>
                                                        <path fill="#3a2f32" d="M45.975 90h46v2h-46zM45.975 136h46v2h-46z" opacity="1" data-original="#3a2f32"></path>
                                                        <path fill="url(#a)" d="M65.405 176.324h7.618v24.621h-7.618z" opacity="1" data-original="url(#a)"></path>
                                                    </g>
                                                </svg>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center pt-2">
                                        <!-- Amount -->
                                        <h3 class="mb-0 fs-22 text-dark me-3"><?php echo "$count3" ?></h3>
                                        <div class="text-center">
                                            <p class="text-dark fs-13 mb-0">
                                                Till <?php echo date('d M, Y'); ?>
                                            </p>
